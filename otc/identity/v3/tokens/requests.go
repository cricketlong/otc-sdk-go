...
func (opts *AuthOptions) ToTokenV3CreateMap(scope map[string]interface{}) (map[string]interface{}, error) {
	OTCAuthOpts := opentelekomcloud.AuthOptions{
	...
	return OTCAuthOpts.ToTokenV3CreateMap(scope)
}
...
func (opts *AuthOptions) ToTokenV3ScopeMap() (map[string]interface{}, error) {
	if opts.Scope.ProjectName != "" {
		...
		if opts.Scope.DomainID == "" && opts.Scope.DomainName == "" {
			return nil, opentelekomcloud.ErrScopeDomainIDOrDomainName{}
		}
		if opts.Scope.ProjectID != "" {
			return nil, opentelekomcloud.ErrScopeProjectIDOrProjectName{}
		}
		...
		if opts.Scope.DomainID != "" {
			return nil, opentelekomcloud.ErrScopeProjectIDAlone{}
		}
		if opts.Scope.DomainName != "" {
			return nil, opentelekomcloud.ErrScopeProjectIDAlone{}
		}
		...
		return nil, opentelekomcloud.ErrScopeDomainName{}
	}
...
func subjectTokenHeaders(c *opentelekomcloud.ServiceClient, subjectToken string) map[string]string {
...
func Create(c *opentelekomcloud.ServiceClient, opts AuthOptionsBuilder) (r CreateResult) {
