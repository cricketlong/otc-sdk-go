...
type ErrEndpointNotFound struct{ opentelekomcloud.BaseError }
...
type ErrInvalidAvailabilityProvided struct{ opentelekomcloud.ErrInvalidInput }
...
// found
type ErrNoAuthURL struct{ opentelekomcloud.ErrInvalidInput }
...
// found
type ErrNoUsername struct{ opentelekomcloud.ErrInvalidInput }
...
// found
type ErrNoPassword struct{ opentelekomcloud.ErrInvalidInput }
